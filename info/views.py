...
def attendance_detail(request, stud_id, course_id):
    ...
    return render(request, 'att_detail.html', {'att_list': att_list, 'cr': cr})
...
def t_student(request, assign_id):
    ...
    for stud in ass.class_id.student_set.all():
        try:
            ...
            a.save()
        att_list.append(a)
    return render(request, 't_students.html', {'att_list': att_list})
...
def t_class_date(request, assign_id):
    ...
    return render(request, 't_class_date.html', {'att_list': att_list})
...
def t_attendance_detail(request, stud_id, course_id):
    ...
    cr = get_object_or_404(Course, id=course_id)
    att_list = Attendance.objects.filter(course=cr, student=stud).order_by('date')
    return render(request, 't_att_detail.html', {'att_list': att_list, 'cr': cr})
...
def t_extra_class(request, assign_id):
    ...
    return render(request, 't_extra_class.html', context)
...
def t_report(request, assign_id):
    ...
    for stud in ass.class_id.student_set.all():
        ...
        sc_list.append(a)
    return render(request, 't_report.html', {'sc_list': sc_list})
...
def free_teachers(request, asst_id):
    ...
    return render(request, 'free_teachers.html', {'ft_list': ft_list})
...
def t_marks_list(request, assign_id):
    ...
    return render(request, 't_marks_list.html', {'m_list': m_list})
...
def student_marks(request, assign_id):
    ...
    return render(request, 't_student_marks.html', {'sc_list': sc_list})
